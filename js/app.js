    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            const picker = datepicker_min("[data-datepicker]", {
                ...
                customMonths: [ "Янв", "Февр", "Март", "Апр", "Май ", "Июнь ", "Июль ", "Авг", "Сент", "Окт", "Ноябрь", "Декаб" ],
                overlayButton: "Применить",
                overlayPlaceholder: "Год (4 цифри)",
                startDay: 1,
        ...
        const inputMasks = document.querySelectorAll(".form-contacts__input_mask");
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+7 999 9999999").mask(inputMasks);
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                nouislider.create(item, {
                    start: [ parseInt(fromValue.value), parseInt(toValue.value) ],
                    connect: true,
                    tooltips: [ true, true ],
                    range: {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".products-slider__slider")) new core(".products-slider__slider", {
                ...
                watchOverflow: true,
                navigation: {
                    prevEl: ".products-slider__arrow_left",
                    nextEl: ".products-slider__arrow_right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.1,
            ...
            if (document.querySelector(".thumbs-sliders__slider")) {
                const thumbsSwiper = new core(".thumbs-sliders__slider", {
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".thumbs-sliders__arrow_left",
                        nextEl: ".thumbs-sliders__arrow_right"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 3,
                ...
                new core(".sliders-review__slider", {
                    modules: [ Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    navigation: {
                        prevEl: ".sliders-review__arrow_left",
                        nextEl: ".sliders-review__arrow_right"
                    }
                });
            }
        }
        ...
        da.init();
        const optionsList = document.querySelector(".navigation-blog__options");
        if (optionsList) document.addEventListener("DOMContentLoaded", (function() {
            optionsList.addEventListener("change", (function(event) {
                if ("option1" === event.target.name) {
                    const optionsItems = document.querySelectorAll(".options__item");
                    const selectedOptionsText = event.target.closest(".options__item").querySelector(".blog-option-text");
                    optionsItems.forEach((function(optionsItem) {
                        const optionsText = optionsItem.querySelector(".blog-option-text");
                        if (optionsText === selectedOptionsText) optionsText.classList.add("radio-checked"); else optionsText.classList.remove("radio-checked");
                    }));
                }
            }));
        }));
